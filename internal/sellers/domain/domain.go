...
type Repository interface {
	...
	Create(ctx context.Context, cid int, commpanyName, address, telephone string) (Seller, error)
	Update(ctx context.Context, id, cid int, commpanyName, address, telephone string) (Seller, error)
