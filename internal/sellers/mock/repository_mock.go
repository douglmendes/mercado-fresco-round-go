...
func (m *MockRepository) Create(id, cid int, commpanyName, address, telephone string) (sellers.Seller, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetAll() ([]sellers.Seller, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetById(id int) (sellers.Seller, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(id, cid int, commpanyName, address, telephone string) (sellers.Seller, error) {
	m.ctrl.T.Helper()
