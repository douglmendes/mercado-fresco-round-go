...
func (m *MockRepository) Create(id int, address, telephone, warehouseCode string, minimunCapacity, minimunTemperature int) (warehouses.Warehouse, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetById(id int) (warehouses.Warehouse, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(id int, address, telephone, warehouseCode string, minimunCapacity, minimunTemperature int) (warehouses.Warehouse, error) {
	m.ctrl.T.Helper()
