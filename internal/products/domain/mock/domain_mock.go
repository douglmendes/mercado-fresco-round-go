...
// Source: github.com/douglmendes/mercado-fresco-round-go/internal/products/domain (interfaces: Repository,Service)
...
func (m *MockRepository) Create(arg0 domain.Product) (domain.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) GetById(arg0 int) (domain.Product, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepository) Update(arg0 domain.Product) (domain.Product, error) {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockService) Create(arg0 domain.Product) (domain.Product, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", arg0)
	ret0, _ := ret[0].(domain.Product)
	ret1, _ := ret[1].(error)
...
// GetById mocks base method.
func (m *MockService) GetById(arg0 int) (domain.Product, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetById", arg0)
	ret0, _ := ret[0].(domain.Product)
	ret1, _ := ret[1].(error)
...
// Update mocks base method.
func (m *MockService) Update(arg0 domain.Product) (domain.Product, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", arg0)
	ret0, _ := ret[0].(domain.Product)
	ret1, _ := ret[1].(error)
